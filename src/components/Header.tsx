            ...
            <div className="container m-auto">
                <div className="grid md:grid-cols-2 sm:grid-cols-1">
                    <div className="flex-1">
                        <h1 className="text-3xl md:text-6xl font-bold mb-5 mt-28 text-center md:text-left leading-10 font-sans" dangerouslySetInnerHTML={{__html: Content.header.title}} />
